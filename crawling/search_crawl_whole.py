...
for i in range(len(item_list)):
    ...
    save_path = f"./crawl_image/"
    create_dir_if_not_exist(save_path)

    for t, url in enumerate(image_url, 0):
        if t < 10:
            urlretrieve(url, save_path + image_name + "_000" + str(t) + ".jpg")
        elif t < 100:
            urlretrieve(url, save_path + image_name + "_00" + str(t) + ".jpg")
        elif t < 1000:
            urlretrieve(url, save_path + image_name + "_0" + str(t) + ".jpg")
        else:
